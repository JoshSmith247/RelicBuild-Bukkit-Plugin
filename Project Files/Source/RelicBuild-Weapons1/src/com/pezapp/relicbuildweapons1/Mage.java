    ...
    public static void PlayerInteractEvent(PlayerInteractEvent event) {
    	...
    	//if (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK) {
    		Player eventPlayer = event.getPlayer();
  		    ItemStack attackItem = eventPlayer.getEquipment().getItemInMainHand();
    		if (attackItem.getType() == Material.BLAZE_ROD && System.currentTimeMillis() - lastUsed >= cooldown * 1000) {
    	        ...
    	        Fireball f = eventPlayer.launchProjectile(Fireball.class);
    			...
    			eventPlayer.sendMessage(ChatColor.GRAY + "Active Cooldown of " + timeLeft + " seconds remaining");
    		}
    	//}
    }
}
