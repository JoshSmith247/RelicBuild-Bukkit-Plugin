...
public class Healer implements Listener {
    ...
    public Healer(Plugin instance)
    {
        plugin = instance;
    }
    
    Map<UUID, Long> healthPots = com.pezapp.relicbuild.Plugin.healthPots;
    Map<String, Long> healthCooldowns = com.pezapp.relicbuild.Plugin.healthCooldowns;
